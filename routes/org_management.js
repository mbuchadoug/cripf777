  ...
  try {
    ...
    if (isCripfcntSchool && isAdmin) {
      ...
      exams = await ExamInstance.aggregate([
        ...
        { $group: { _id: "$assignmentId", doc: { $first: {
