...
export function visitTracker(req, res, next) {
  try {
    ...
    setImmediate(async () => {
      try {
        // Defensive: ensure values exist and are strings/numbers as expected
        const upsertFilter = { day, path };
        const upsertUpdate = {
          $inc: { hits: 1 },
        ...
        if (visitorId) {
          ...
          try {
            ...
            // ignore code 11000, warn on others
            if (e && e.code !== 11000) {
