 ...
 * 
 * Usage:
 *   node scripts/tag_home_questions.js
 * 
 * Options:
...
1. "topic" - Specific micro-topic (e.g., "fractions", "multiplication-tables", "verb-tenses", "photosynthesis", "honesty", "time-management")
